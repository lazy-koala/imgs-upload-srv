...
<div class="wrapper">
  ...
  <div class="list-wrapper" v-loading="globalLoading">
    ...
    <div class="pagation" v-show="imgList.length > 0">
      <el-pagination layout="total, prev, pager, next" :total="page.totalCount" :page-size='page.pageSize' @size-change="handleSizeChange" @current-change="handleCurrentChange">
      </el-pagination>
    </div>
  </div>
  <template>
  ...
  <el-dialog title="图片裁剪" v-if="data.loaded" :visible.sync="data.loaded" width="45%" center :before-close="handleClose">
